...
<html>
    ...
    <form action="contactinfo.php" method="post">
        ...
        <select name="event">
            ...
            <option value="garba">Graba</option>
            ...
            <option value="sweet">Sweet 16</option>
        ...
        <input type="tel" name="NOG" required>
        </div>
        ...
        <div style="padding-bottom: 25px;">
        <label>Destination Wedding (Enter Country)</label>
        ...
        <div style="padding-bottom: 25px;">
        <label>Ice Gola Package</label>
        <select name="package">

            <option value="">-Select-</option>
            <option value="silver">Silver-10</option>
            <option value="golden">Golden-15</option>
        ...
        <button type="submit" name="submit" class="but">Submit</button>
